...
Data is provided through a [color based transmitter](eng1003.eng.monash.edu/apps/morsetransmitter) by default but can be made to read data from sound, radiowaves, etc.
